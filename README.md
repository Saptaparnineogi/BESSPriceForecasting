...
|------------|:-----:|-------------|
| **Battery Capacity** | **100 MWh** | Representative utility-scale Battery Energy Storage System (BESS). |
| **Power Rating** | **50 MW** | Supports a maximum charge/discharge duration of approximately 2 hours. |
| **Round-trip Efficiency** | **90%** | Typical efficiency assumed for lithium-ion battery systems. |
| **Minimum State of Charge (SoC)** | **10 MWh (10%)** | Lower operating limit to reduce degradation from deep discharge. |
| **Maximum State of Charge (SoC)** | **95 MWh (95%)** | Upper operating limit to prevent overcharging and maintain operational headroom. |
| **Energy per Settlement Period** | **25 MWh** | Maximum transferable energy during a 30-minute settlement period (50 MW × 0.5 h). |
...
| Step | Description |
|------|-------------|
| **Decision Input** | Forecasted day-ahead electricity prices generated by the forecasting model. |
| **Charging Strategy** | Charge during the **40% lowest forecast-price** settlement periods, subject to battery constraints. |
| **Discharging Strategy** | Discharge during the **40% highest forecast-price** settlement periods. |
| **Operational Constraints** | Enforce battery capacity, power rating, minimum SoC, maximum SoC, and round-trip efficiency. |
| **Revenue Evaluation** | Calculate arbitrage revenue using the **realized market prices** rather than the forecasted prices. |
